...
![3-ethyl-5-phenylimidazolidine-2,4-dione represented by SMILES string 'CCN1C(=O)NC(c2ccccc2)C1=O' being converted into networkx graphical form for training](../assets/gnns/smile.webp)
...
![GNN Architecture](../assets/gnns/full_architecture.webp)
...
![Graph Batch, Source: CS 224W Colab 3](../assets/gnns/graph_batch.webp)
...
![GCN on AMES](../assets/gnns/gcn_ames.webp)
![GAT on AMES](../assets/gnns/gat_ames.webp)
![GraphSage on AMES](../assets/gnns/graphsage_ames.webp)
...
![GCN using BatchNorm vs GraphNorm](../assets/gnns/batchnorm_vs_graphnorm.webp)
...
![GAT Performance on ClinTox dataset](../assets/gnns/gat_clintox.webp)
...
![GAT Recall on ClinTox](../assets/gnns/gat_recall_clintox.webp)
...
![GAT with weighted loss on ClinTox](../assets/gnns/gat_weighted_clintox.webp)
